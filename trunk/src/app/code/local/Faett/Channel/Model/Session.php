 ...
 */
class Faett_Channel_Model_Session extends Mage_Api_Model_Session
{
    ...
    public function isAllowed($resource, $privilege=null)
    {
        ...
        if ($user && $acl) {        	
            ...
            try {
            	...
            	Mage::log('Found ACL role: ' . $user->getAclRole());
            	Mage::log('Found resource: ' . $resource);
            	Mage::log('Found privilege: ' . $privilege);
