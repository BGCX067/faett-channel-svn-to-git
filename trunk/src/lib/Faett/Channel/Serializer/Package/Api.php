...
class Faett_Channel_Serializer_Package_Api
    ...
    public function serialize()
    {
        try {
            ...
            file_put_contents('/tmp/api.xml', $xml = $doc->saveXML());
    ...
    protected function _assert($doc, $api)
    {
        $acl = $doc->createElement('acl');
        	
        	$assert = $doc->createElement('assert');
	    	...
	    	$assert->appendChild($resources);
            
        $acl->appendChild($assert);
