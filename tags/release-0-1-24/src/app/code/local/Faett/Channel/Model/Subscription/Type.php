...
/**
 * Faett_Channel_Model_Subscription_Type
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class Faett_Channel_Model_Subscription_Type
    ...
    {
        $this->_init('channel/subscription_type');
        parent::_construct();
    }

    /**
	 * Returns the subscription type's options.
	 *
	 * @return Faett_Channel_Model_Mysql4_Subscription_Type_Option_Collection
	 * 		The collection with the options
     */
    public function getOptions()
    {
         return Mage::getModel('channel/subscription_type_option')
             ->getCollection()
             ->addFieldToFilter('subscription_type_id_fk', $this->getId());
    }
}