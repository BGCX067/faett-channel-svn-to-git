...
/**
 * Faett_Channel_Model_Link_Update
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class Faett_Channel_Model_Link_Update
    ...
    {
        parent::_construct();
        $this->_init('channel/link_update');
    }
     ...
     * @return Faett_Channel_Model_Link_Update The instance
     */
    public function loadByLinkIdFk($linkIdFk)
    {
        $this->setData(
            $this->getResource()->loadByLinkIdFk(
                $this, 
                $linkIdFk
            )
        );
