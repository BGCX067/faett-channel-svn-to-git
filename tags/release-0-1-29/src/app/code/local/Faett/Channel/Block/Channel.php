...
/**
 * Block to render XML structure for a channel request.
 *
 * @category   	Faett
 * @package    	Faett_Channel
 ...
 */
class Faett_Channel_Block_Channel 
    ...
    {	
    	...
    	return Faett_Channel_Model_Channel::CACHE_TAG .
    		'_' . $this->getChannel()->getId();
    }
    
    /**
     * Returns the channel set in the controller.
     * 
    ...
    protected function _toHtml() 
    {
    	...
    	return $this->getChannel()->__toXML();
    }
}