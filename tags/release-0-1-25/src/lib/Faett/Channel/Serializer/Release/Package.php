 ...
 */
class Faett_Channel_Serializer_Release_Package
    ...
    {
        // load the package link
        $model = Mage::getModel('package/link')
        ...
        $doc = new DOMDocument();
        // load the package file content
        $doc->loadXML($model->getPackageFile());
