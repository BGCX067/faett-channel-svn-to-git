...
/**
 * Faett_Channel_Exceptions_InvalidResourcePathException
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class Faett_Channel_Exceptions_InvalidResourcePathException
     ...
     * @return Faett_Channel_Exceptions_InvalidResourcePathException
     */
    public static function create($message, $key = '') {
        // create a new message
        $e = new Faett_Channel_Exceptions_InvalidResourcePathException($message);
        // set the message key
        $e->_setKey($key);
        // return the message
        return $e;
