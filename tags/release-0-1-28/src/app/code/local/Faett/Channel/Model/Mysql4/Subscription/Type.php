...
/**
 * Faett_Channel_Model_Mysql4_Subscription_Type
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class Faett_Channel_Model_Mysql4_Subscription_Type
    ...
    {
        $this->_init('channel/subscription_type', 'subscription_type_id');
    }
}