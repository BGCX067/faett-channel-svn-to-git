...
/**
 * Faett_Channel_Serializer_Category_Info
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class Faett_Channel_Serializer_Category_Info
    ...
    public function serialize()
    {
        try {
            ...
            $n->nodeValue = $this->_category->getOptionValue();
