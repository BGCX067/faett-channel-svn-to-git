...
/**
 * Block to render the forbidden page.
 *
 * @category   	Faett
 * @package    	Faett_Channel
 ...
 */
class Faett_Channel_Block_Forbidden 
	extends Mage_Core_Block_Template {

	/**
	 * Key for the message to send for requesting a forbidden page.
	 * @var string
	 */
	const MESSAGE = 'forbidden_message';
	...
	{
		$this->setTemplate('channel/forbidden.phtml');
	}
	...
	{
		return Mage::registry(Faett_Channel_Block_Forbidden::MESSAGE);
	}
}