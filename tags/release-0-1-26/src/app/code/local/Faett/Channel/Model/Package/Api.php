...
class Faett_Channel_Model_Package_Api
    ...
    /**
     * Validates the licence for the package, passed 
     * from the customer's shop.
     *
     * @param unknown_type $licence
     * @param unknown_type $websiteCode
     * @param unknown_type $attributes
     * @return boolean TRUE if the passed serialz is valid, else FALSE
     */  
    public function validateSimple($identifier, $websiteCode, $attributes = null)
    {
        ...
        foreach ($collection as $linkPurchasedId => $linkPurchased) {            
            ...
            if (Mage::getModel('channel/serialz')
                ->init($linkPurchased)
                ->isValid($linkPurchased->getSerialz())) {
        ...
        $this->_fault(
        	'licence_invalid', 
        	'No valid licence found for customer ' . $customerId . ' and product ' . $productId
        );      
    }
     ...
     * @param unknown_type $attributes
     * @return boolean TRUE if the passed serialz is valid, else FALSE
     * @deprecated Will be removed, use {@see Faett_Channel_Model_Package::validateSimple($identifier, $websiteCode, $attributes = null)} instead
     */
