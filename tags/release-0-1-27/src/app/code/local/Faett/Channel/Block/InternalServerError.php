...
/**
 * Faett_Channel_Block_InternalServerError
 *
 * NOTICE OF LICENSE
 * 
...
/**
 * Block to render an internal server error page.
 *
 * @category   	Faett
 * @package    	Faett_Channel
 ...
 */
class Faett_Channel_Block_InternalServerError 
	extends Mage_Core_Block_Template {

	/**
	 * Key for the message to send for an internal server error.
	 * @var string
	 */
	...
	{
		$this->setTemplate('channel/internal_server_error.phtml');
	}
	...
	{
		return Mage::registry(Faett_Channel_Block_InternalServerError::MESSAGE);
	}
}