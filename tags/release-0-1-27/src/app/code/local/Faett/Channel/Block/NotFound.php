...
/**
 * Block to render the not found page.
 *
 * @category   	Faett
 * @package    	Faett_Channel
 ...
 */
class Faett_Channel_Block_NotFound 
	extends Mage_Core_Block_Template {

	/**
	 * Key for the message to send for requesting a page that can't be found.
	 * @var string
	 */
	...
	{
		$this->setTemplate('channel/not_found.phtml');
	}
	...
	{
		return Mage::registry(Faett_Channel_Block_NotFound::MESSAGE);
	}
}